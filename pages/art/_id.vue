<template>
  <div class="gradient text-white">
    <div
      class="leading-normal cursor-pointer tracking-normal text-white bg-black bg-opacity-25 textShadow"
    ...
    <div class="bg-white">
      ...
      <div class="mx-auto w-full h-auto md:w-1/3 p-3">
        ...
        <div class="flex items-center" @click="goTop">
          <div
            class="cursor-pointer text-center mx-auto buttonCommon text-white font-bold rounded-b py-4 w-full shadow-lg"
          >
            {{ $t("ポケモンAAツクールを試す") }}
          </div>
        </div>
...
export default {
  ...
  head() {
    return {
      title: this.$t("ポケモンAA画像を作ろう"),
      meta: [
        {
          hid: "description",
          name: "description",
          content: this.$t("ポケモンAA画像を作ろう"),
        },
        { hid: "og:type", property: "og:type", content: "article" },
        {
          hid: "og:title",
          property: "og:title",
          content: this.$t("ポケモンAAツクール"),
        },
        {
          hid: "og:description",
